...
export const YEARS = [
  {
    year: 2018,
    key: 'DIPLOMA START',
    lines: ['Government Polytechnic College', 'Diploma in Computer Science', 'Aug 2018 - Dec 2021', 'Skills: HTML, Java'],
  },
  {
    year: 2021,
    key: 'DIPLOMA COMPLETED',
    lines: ['Government Polytechnic College', 'Diploma in Computer Science', 'Dec 2021'],
  },
  {
    year: 2023,
    key: 'SOFTWARE ENGINEER',
    lines: ['Iclonis Tech Solutions', 'Junior Software Engineer', 'Apr 2023 - Present', 'Bengaluru, Karnataka, India', 'Web Development, Troubleshooting, and other software development skills'],
  },
  {
    year: 2023,
    key: 'BACHELOR\'S DEGREE',
    lines: ['Jain (Deemed-to-be University)', 'Bachelor of Computer Applications (BCA)', 'Oct 2023 - Jun 2026', 'Skills: SQL, Java, and other software development skills'],
  },
  {
    year: 2026,
    key: 'NOW & NEXT',
    lines: ['Junior Software Developer', 'Iclonis Tech Solutions', 'Growing through software development, web development, problem solving, and building modern technology solutions.'],
  },
];
...
const REF = {
  ...
  cards: [
    [0.2047, 0.2875, 0.0810],
    [0.3394, 0.3701, 0.0898],
    [0.4813, 0.4340, 0.0985],
    [0.6523, 0.4958, 0.1080],
    [0.8180, 0.5292, 0.1240],
  ],
